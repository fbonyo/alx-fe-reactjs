      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex space-x-4">
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg hover:shadow-lg transition">
                Add Recipe
              </button>
            </div>
          </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Italian', 'Asian', 'Desserts', 'Vegetarian', 'Quick Meals', 'Healthy', 'Comfort Food', 'Breakfast'].map((category) => (
              <div key={category} className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-xl transition duration-300 cursor-pointer hover:bg-orange-50">
                <div className="text-2xl mb-2">🍝</div>
                <h4 className="font-semibold text-gray-800">{category}</h4>
                <p className="text-sm text-gray-500 mt-1">Explore recipes</p>
              </div>
            ))}
          </div>
        </div>
